...
= 3.18 =
Please upgrade to this version as all data sent via Ajax is sanitized and escaped properly. Paths to specific files are also no longer hard-coded in

= 3.17 =
Please upgrade to this version to fix the PHPMailer vulnerability issue
